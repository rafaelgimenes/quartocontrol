    ...
    public void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                if(ChkLuz.isChecked()) {
                    //envia comando; ON
                        ...
                        ClienteHttpGet clienteOFF = new ClienteHttpGet("http://10.0.0.20/R1=OF");
                        clienteOFF.fim();
                        /*AlertDialog.Builder dialogo = new AlertDialog.Builder(Principal.this); //dialogo geral
                        dialogo.setTitle("Comando Enviado");
        ...
        btnLCD.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                ClienteHttpGet clienteTxtLcd = new ClienteHttpGet("http://10.0.0.20/TL=" + nStr  );
                clienteTxtLcd.fim();
